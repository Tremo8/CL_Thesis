        ...
        for weight_decay in weight_decay_values:
            for rm_size in rm_sizes:
                for ll in latent_layer:
                    ...
                    cmd = f"python LatentReplay.py --model_name phinet --benchmark_name split_cifar10 --lr {lr} --latent_layer {ll} --train_epochs {epoch} --rm_size {rm_size} --weight_decay {weight_decay} --split_ratio {split_ratio} --device 0"
