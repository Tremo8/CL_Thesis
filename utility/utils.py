...
def model_selection(name, latent_layer, pretrained=True):
    ...
    if name == 'mobilenetv1':
        ...
        model.load_state_dict(torch.load('./model/Pretrained/new_phinet_small_71.pth.tar')["state_dict"])
        ...
        model.load_state_dict(torch.load('./model/Pretrained/new_phinet_divisor8_v2_downsampl.pth.tar')["state_dict"])
        model = PhiNetV1(model=model, latent_layer_num=latent_layer)
        return model
        ...
        model.load_state_dict(torch.load('./model/Pretrained/new_phinet_divisor8_v3.pth.tar')["state_dict"])
        model = PhiNetV1(model=model, latent_layer_num=latent_layer)
        return model
        ...
        model.load_state_dict(torch.load('./model/Pretrained/phinet_13057DS.pth.tar')["state_dict"])
        model = PhiNetV1(model=model, latent_layer_num=latent_layer)
        return model
        ...
        model.load_state_dict(torch.load('./model/Pretrained/phinet_09054DSDE.pth.tar')["state_dict"])
        model = PhiNetV1(model=model, latent_layer_num=latent_layer)
        return model
        ...
        model.load_state_dict(torch.load('./model/Pretrained/phinet_09054DS.pth.tar')["state_dict"])
        model = PhiNetV1(model=model, latent_layer_num=latent_layer)
        return model
    else:
