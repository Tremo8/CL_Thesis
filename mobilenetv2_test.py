...
def main():
    args = parse_args()
    os.makedirs(f"results/{args.benchmark_name}/mobilenetv2/latent_{args.latent_layer}/weight_decay_{args.weight_decay}", exist_ok=True) 

    file_name = f"results/{args.benchmark_name}/mobilenetv2/latent_{args.latent_layer}/weight_decay_{args.weight_decay}/lr_{args.lr}_epochs_{args.train_epochs}_rm_MB_{args.rm_size_MB}_rm_{args.rm_size}_split_{args.split_ratio}.csv"
    model_name = f"results/{args.benchmark_name}/mobilenetv2/latent_{args.latent_layer}/weight_decay_{args.weight_decay}/lr_{args.lr}_epochs_{args.train_epochs}_rm_MB_{args.rm_size_MB}_rm_{args.rm_size}_split_{args.split_ratio}.pth"
    ...
    # Your code
    model5 = MobilenetV2(pretrained=True, latent_layer_num=args.latent_layer).to(device)
