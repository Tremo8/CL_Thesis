...
def main():
    ...
    os.makedirs(f"results/{args.model_name}/{args.benchmark_name}/Joint_Training/latent_{args.latent_layer}/weight_decay_{args.weight_decay}", exist_ok=True) 

    # Define file paths for saving CSV and model checkpoints
    file_name = f"results/{args.model_name}/{args.benchmark_name}/Joint_Training/latent_{args.latent_layer}/weight_decay_{args.weight_decay}/lr_{args.lr}_epochs_{args.train_epochs}_split_{args.split_ratio}.csv"
    model_name = f"results/{args.model_name}/{args.benchmark_name}/Joint_Training/latent_{args.latent_layer}/weight_decay_{args.weight_decay}/lr_{args.lr}_epochs_{args.train_epochs}_split_{args.split_ratio}.pth"
    ...
    # Define train and test streams
    train_stream = benchmark.train_stream
    test_stream = benchmark.test_stream

    train_mb_size = 128  # Define train_mb_size
    ...
    # Train the model
    joint_training.train(train_stream, test_stream, plotting=False)
